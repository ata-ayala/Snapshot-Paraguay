...
[**Abrir formulario de inscripción**](https://qrco.de/bgzxb9){.btn-inscripcion}

Con esta información podremos conocerte mejor y acompañarte en el proceso
de instalación y monitoreo.

Una vez que recibamos tu formulario, el equipo se pondrá en contacto
para los próximos pasos.

Si te surge cualquier duda, podés escribirnos con confianza a:
**snapshotparaguay@gmail.com**

:::

::: {.inscripcion-qr}

[![](images/qr.png){fig-alt="QR del formulario de inscripción"}](https://qrco.de/bgzxb9)

**Escaneá el QR para inscribirte**
